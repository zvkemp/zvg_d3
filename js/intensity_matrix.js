...
(function() {
  ...
  Dashboard.IntensityMatrix = (function() {
    ...
    IntensityMatrix.prototype.render = function() {
      ...
      this.appendSeries1();
      return this.appendSeries2(this);
    };

    IntensityMatrix.prototype.appendSeries1 = function() {
      var _this = this;
      console.log('appendSeries1');
      return this.series_1_groups || (this.series_1_groups = this.svg.selectAll('g.series_1').data(this.data()).enter().append('g').attr('class', 'series_1').attr('transform', function(d) {
  ...
  s2domain = ['Under 25', 'Under 45', '45 to 65', '65 and over'];
