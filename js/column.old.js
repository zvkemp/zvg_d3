...
(function() {
  ...
  ZVG.column = function() {
    ...
    appendSeries2Borders = function() {
      return series_2.append('rect').style('stroke', 'white').style('fill', 'none').style('stroke-width', '1.5pt').attr('x', 0).attr('y', _chartHeight).attr('height', 0).attr('width', columnBand.rangeBand()).attr('opacity', 0).transition().delay(300).duration(700).attr('y', 0).attr('height', _chartHeight).attr('opacity', 0.5);
    };
