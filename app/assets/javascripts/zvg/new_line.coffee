class ZVG.NewLine extends ZVG.ColumnarLayoutChart
  # 1. break into series
  # 2. within each series, connect each 'like' point with a line
  # 3. if there is no line, display a point?
